  ...
  return (
    <section className='mt-16 w-full max-w-xl'>
      <div className='flex flex-col w-full gap-2'>
        ...
        <div className='fle flex-col gap-1 max-h-60 overflow-y-auto'>
      ...
      </div><div className="my-10 max-w-full flex justify-center items-center">
        {isFetching ? (
          <img src={loader} className='w-20 h-20 object-contain' />) : error ? (
            <p className='font-inter font-bold text-black text-center'>
              Well, That wasn't supposed to happen...
              <br />
              <span className='font-satoshi font-normal text-danger-700'>
                {error?.data?.error}
              </span>
            </p>
          ) : (
